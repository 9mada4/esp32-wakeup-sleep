...
12. 書き込み
13. OTGに接続
14. Windows STARTボタンを右クリック＞デバイスマネージャー＞マウスとそのほかのポインティングデバイス＞HID準拠マウス＞プロパティ <details><summary>イベントのタイムスタンプを確認</summary> 書き込んだ時間になっているはずです．また，電源の管理が表示されていない場合はスリープ解除できません． ![](fig/event.png) </details>
